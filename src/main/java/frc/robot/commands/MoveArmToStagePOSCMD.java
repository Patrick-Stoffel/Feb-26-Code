...
public class MoveArmToStagePOSCMD extends Command {
  /** Creates a new MoveArmToPodShotCMD. */
  private final ArmSubsystem armSubsystem;
  private double armVolts;
  

  public MoveArmToStagePOSCMD(ArmSubsystem armSubsystem, double armVolts) {
  ...
  public boolean isFinished() {
    if (armSubsystem.getArmEncoderPOS() <= EncoderConstants.ek_StageShotArmPOS) {
      return true;
    }
    else{return false;}
  }
