...
public class TwoNoteAuto extends SequentialCommandGroup {
    public TwoNoteAuto(Swerve s_Swerve, ShooterSubsystem shooterSubsystem, KickerSubsystem kickerSubsystem, ArmSubsystem armSubsystem, IntakeAndKickerSubsystem intakeAndKickerSubsystem){
